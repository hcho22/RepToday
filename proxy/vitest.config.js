 ...
 * suite needs no deployment, no network, and no Wrangler runtime. The one upstream model call
 * is stubbed on `globalThis.fetch`, which lets the tests prove the boundary: a valid request makes
 * exactly one upstream call and returns a reply or typed safety outcome; an oversized/invalid

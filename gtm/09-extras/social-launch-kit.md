...
> **SUPERSEDED (v2, 2026-08-01). Kept as v1 history only.**
> The social PMF test kit at [../05-social-pmf/](../05-social-pmf/) replaces this file as the operating instrument for organic social (decisions-log.md D-101; channel-plan.md section 5).
> Do not post from this file.
> Its still-valid drafts are folded into the PMF kit; anything here that conflicts with the kit, the v2 [positioning](../02-brand/positioning.md), or the v2 [naming decision](../02-brand/naming-decision.md) (listing name is plain "Rep Today"; hero is "Open the app. The workout is already there.") is superseded by those files.

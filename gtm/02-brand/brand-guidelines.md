# Rep Today - Brand Guidelines v1.0
...
**Rep Today** is a discipline-first micro-workout iOS app.
...
- App Store listing name: **Rep Today, Rest Tomorrow**. Under-icon display name: **Rep Today**.
...
|-------------|---------------|
| "Crush your goals with AI-powered workouts!" | "Open the app. Your workout is already there." |
...
- Subhead: "A full bodyweight session, built on your phone in under 100 milliseconds. No questions, no account, no internet needed. Press Start."
  Scope note: "no questions" means the open-to-start path - no quiz, no sign-up, nothing between open and Start.
...
- Forgiveness: "Missing a day never zeroes you out."
...
## 10. What Rep Today never does (brand-wide)

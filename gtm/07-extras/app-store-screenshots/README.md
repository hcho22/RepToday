...
|---|------|---------|---------------------|
| 1 | `01-ready-screen.png` | Open the app. Your workout is already there. | Ready Screen: pre-generated 10-minute session, duration chips (10 selected), six movement blocks across all three pillars, one dominant Start button. |

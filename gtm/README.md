...
| `10-instagram/` | Launch profile presence: 7-slide carousels authored as HTML and rendered to PNG, with captions and alt text, a behavioral claim-verification table (`claim-verification.md`), and four re-runnable guards wired into `render.sh`; Gate 0 blocks posting (see the folder README) |

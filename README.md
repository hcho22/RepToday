...
│   │   └── Programmer/      # Deterministic AI Programmer (re-program trigger detection, plateau diagnosis, Default Duration learning, templated policy note, pure, on-device)

...
2. **Pillar balance** - a single-focus (5-10 min) session always trains strength (mobility survives only as the warm-up); a blend splits time between strength and mobility by days-since-worked staleness, with a strength bias for users who don't sit long.
